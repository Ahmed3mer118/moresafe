    ...
    <>
      ...
      <aside
        className={clsx(
          ...
          'fixed lg:sticky top-0 h-screen transition-transform duration-300',
          'lg:translate-x-0',
      ...
      >
        <div className="p-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-[42px] h-[42px] rounded-xl grid place-items-center font-black text-lg shadow-lg">
        ...
        <div className="p-4 border-t border-white/10 bg-[#1a3354]/60">
          {user && (
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/8 border border-white/10 mb-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 text-white grid place-items-center font-extrabold text-sm shrink-0 shadow-md">
                {user.name.charAt(0)}
              </div>
